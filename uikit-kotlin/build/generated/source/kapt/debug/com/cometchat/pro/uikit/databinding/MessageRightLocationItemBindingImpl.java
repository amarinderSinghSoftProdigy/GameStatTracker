...
public class MessageRightLocationItemBindingImpl extends MessageRightLocationItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_map, 3);
        sViewsWithIds.put(R.id.tv_place_name, 4);
        sViewsWithIds.put(R.id.sender_location_txt, 5);
        sViewsWithIds.put(R.id.navigate_btn, 6);
    ...
    public MessageRightLocationItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private MessageRightLocationItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
