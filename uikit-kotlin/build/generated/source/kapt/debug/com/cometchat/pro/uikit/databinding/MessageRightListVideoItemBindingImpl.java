...
public class MessageRightListVideoItemBindingImpl extends MessageRightListVideoItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cv_image_message_container, 2);
        sViewsWithIds.put(R.id.go_video_message, 3);
        sViewsWithIds.put(R.id.playBtn, 4);
        sViewsWithIds.put(R.id.img_progress_bar, 5);
        sViewsWithIds.put(R.id.reaction_group, 6);
        sViewsWithIds.put(R.id.reactions_layout, 7);
        sViewsWithIds.put(R.id.reply_avatar_layout, 8);
        sViewsWithIds.put(R.id.thread_reply_count, 9);
    ...
    public MessageRightListVideoItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private MessageRightListVideoItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
