...
public class MessageRightListImageItemBindingImpl extends MessageRightListImageItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.go_img_message, 3);
        sViewsWithIds.put(R.id.sensitive_layout, 4);
        sViewsWithIds.put(R.id.sensitive_desc, 5);
        sViewsWithIds.put(R.id.img_progress_bar, 6);
    ...
    public MessageRightListImageItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private MessageRightListImageItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
