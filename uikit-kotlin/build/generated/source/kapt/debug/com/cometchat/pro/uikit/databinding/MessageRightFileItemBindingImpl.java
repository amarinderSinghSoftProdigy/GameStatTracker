...
public class MessageRightFileItemBindingImpl extends MessageRightFileItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvFileSize, 4);
        sViewsWithIds.put(R.id.ivIcon, 5);
        sViewsWithIds.put(R.id.tvFileExtension, 6);
        sViewsWithIds.put(R.id.reaction_group, 7);
        sViewsWithIds.put(R.id.reactions_layout, 8);
        sViewsWithIds.put(R.id.reply_avatar_layout, 9);
    ...
    public MessageRightFileItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private MessageRightFileItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
