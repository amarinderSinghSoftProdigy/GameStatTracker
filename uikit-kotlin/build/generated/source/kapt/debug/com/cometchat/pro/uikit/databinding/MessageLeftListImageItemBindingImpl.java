...
public class MessageLeftListImageItemBindingImpl extends MessageLeftListImageItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.reaction_group, 10);
        sViewsWithIds.put(R.id.reactions_layout, 11);
        sViewsWithIds.put(R.id.reply_avatar_layout, 12);
        sViewsWithIds.put(R.id.thread_reply_count, 13);
    }
    // views
    @NonNull
    ...
    public MessageLeftListImageItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }
    private MessageLeftListImageItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
