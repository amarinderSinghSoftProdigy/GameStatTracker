    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier.fillMaxWidth(), horizontalAlignment = Alignment.End) {
                Icon(
                    painter = painterResource(id = com.allballapp.android.R.drawable.ic_close_color_picker),
                    contentDescription = null,
                    modifier = Modifier
                        .size(dimensionResource(id = com.allballapp.android.R.dimen.size_16dp))
                        .clickable {
                            onDismiss.invoke()
            ...
            Spacer(modifier = Modifier.height(dimensionResource(id = com.allballapp.android.R.dimen.size_100dp)))

            Image(
                painter = painterResource(id = R.drawable.ic_all_ball_logo),
                contentDescription = null,
                modifier = Modifier
                    .height(dimensionResource(id = com.allballapp.android.R.dimen.size_95dp))
                    .width(dimensionResource(id = com.allballapp.android.R.dimen.size_160dp)),
            )

            Spacer(modifier = Modifier.height(dimensionResource(id = com.allballapp.android.R.dimen.size_60dp)))
            ...
            Spacer(modifier = Modifier.height(dimensionResource(id = com.allballapp.android.R.dimen.size_20dp)))
